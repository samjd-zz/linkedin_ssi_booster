...
- **Notes:** 0 skipped, 0 failed. All 924 tests pass cleanly. Source coverage is 66%; the previous 98% README badge was a static/manual value without a reproducible coverage command or dependency in the project.
