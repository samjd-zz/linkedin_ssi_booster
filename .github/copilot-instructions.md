...
- **Update `docs/testing-and-dev.md`** whenever the test count changes (current: 823 passed, 0 skipped) or new behaviour is covered — keep the test table and count in sync.
...
- **Test Count**: 837 collected; 837 passed, 0 skipped, 0 failed
