...
- **Update `docs/testing-and-dev.md`** whenever the test count changes (current: 897 passed, 0 skipped) or new behaviour is covered — keep the test table and count in sync.
...
- **Version**: alpha-v0.0.3.6
- **Test Count**: 897 collected; 897 passed, 0 skipped, 0 failed
