...
def compose_lyrics(
    ...
    language_instruction = {
        "japanese": (
            ...
            "first [romaji pronunciation], then [English meaning]. These cues are instructional annotations, not sung lyrics. "
        ...
        "bilingual": (
            ...
            "For learner support, follow important Japanese lines with optional square-bracket cues: first [romaji pronunciation], then [English meaning]. "
    ...
    final_rule = (
        ...
        if lyric_language == "english"
               ...
               "When learner support helps, add square-bracket annotations immediately below the Japanese line: first [romaji pronunciation], then [English meaning]. "
        ...
        for attempt in range(1, max_attempts + 1):
            ...
            if lyric_language == "bilingual" and attempt == 2:
                attempt_user_prompt += (
                    ...
                    "- Add optional learner cues immediately below important Japanese lines: first [romaji pronunciation], then [English meaning].\n"
